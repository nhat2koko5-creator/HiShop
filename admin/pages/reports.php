...
$sql = "
    SELECT 
        DATE(dh.ngay_hoan_thanh) as ngay, -- [SỬA] Dùng ngày hoàn thành thay vì ngày đặt
    ...
    WHERE dh.trang_thai_thanh_toan = 'Đã thanh toán' 
      AND dh.trang_thai_don_hang = 'Đã giao hàng' -- [QUAN TRỌNG] Chỉ tính đơn đã giao xong
      AND dh.ngay_hoan_thanh IS NOT NULL          -- Phải có ngày hoàn thành
...
<div class="admin-page-container">
    ...
    <div class="main-card-box" style="margin-bottom: 25px;">
        <div class="chart-header">
            <h3 class="box-title">Xu hướng Tài chính (Doanh thu & Lợi nhuận)</h3>
        </div>
            ...
            <table class="table-custom">
                ...
                <tbody>
                    <?php if (empty($report_data)): ?>
                        <tr><td colspan="5" class="text-center text-muted" style="padding: 40px;">Không có dữ liệu.</td></tr>
                    <?php else: ?>
...
<script>
    ...
    new Chart(ctx, {
        ...
        options: {
            ...
            interaction: { mode: 'index', intersect: false }, // Rê chuột hiện cả 2 số liệu
            plugins: {
