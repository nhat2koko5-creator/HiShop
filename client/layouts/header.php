<?php
    // $page_title được định nghĩa từ file index.php
    if (!isset($page_title)) {
...
<head>
    ...
    <link rel="stylesheet" href="./assets/font-icon/fontawesome-free-7.0.0-web/css/all.min.css">
</head>
<body>
        ...
        <nav class="header-nav">
            ...
            <div class="nav-center-links">
                ...
                <div class="nav-item has-dropdown">
                    ...
                    <div class="dropdown-menu">
                        <a href="index.php?page=product_list&category=gaming">Laptop Gaming</a>
                        <a href="index.php?page=product_list&category=office">Laptop Văn Phòng</a>
                        <a href="index.php?page=product_list&category=graphics">Laptop Đồ Họa</a>
                    </div>
                </div>
            ...
            <div class="nav-right-actions">
                ...
                <a href="index.php?page=cart" class="icon-btn">
                    🛒 </a>
                <a href="index.php?page=login" class="icon-btn">
                    👤 </a>
            </div>
        </nav>
    </header>
